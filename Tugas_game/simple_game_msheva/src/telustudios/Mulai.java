...
public class Main {
    public static void main(String[] args) {
        ...
        Scene scene4 = new Scene(
            "Kamu menemukan pondok tua di dalam hutan.\n" +
            "Ada asap mengepul dari cerobong asapnya, menandakan ada seseorang di dalam.",
            "Ketuk pintu dan minta bantuan", scene5, 0, 15,
            "Intip melalui jendela untuk melihat siapa di dalam", scene5, 5, 10,
            "Lewati pondok dan lanjutkan perjalanan", scene6, 10, 5
        );
        ...
        Scene scene3 = new Scene(
            ...
            "Berjalan menyusuri tepi padang rumput", scene4, 0, 10,
            "Ambil jalan pintas melintasi padang rumput", scene5, 5, 15,
            "Beristirahat sejenak dan mengamati sekitar", scene4, 0, 5
        );
        ...
        Scene scene2 = new Scene(
            ...
            "Masuk ke dalam gua untuk menyelidiki", scene3, 10, 20,
            "Ambil obor yang ada di depan gua", scene3, 0, 10,
            "Abaikan gua dan lanjutkan perjalanan", scene3, 5, 5
        );
        ...
        Scene scene1 = new Scene(
            ...
            "Ambil jalan setapak ke kiri yang tampak gelap", scene2, 5, 10,
            "Ambil jalan setapak ke tengah yang lebih lebar", scene3, 0, 5,
            "Ambil jalan setapak ke kanan yang menuju ke atas bukit", scene4, 10, 15
        );
